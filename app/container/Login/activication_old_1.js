                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <ImageBackground source={{ uri: 'ic_form_login' }} style={{
                                width: "100%",
                                height: 67.5,
                                justifyContent: "center"
                            }}>
                        ...
                        <View style={{
                            ...
                            <ImageBackground source={{ uri: 'ic_form_lock' }} style={{
                                width: "100%",
                                height: 67.4,
                                justifyContent: "center"
                            }}>
                        ...
                        <View style={{
                            ...
                            >
                                ...
                                <Image style={{ width: "80%", height: 60, resizeMode: 'contain' }} source={{ uri: 'ic_btn_login' }} />
                            </TouchableOpacity>
                            <TouchableOpacity
                                style={{
                                    width: "100%",
                            ...
                            >
                                ...
                                <Image style={{ width: "80%", height: 60, resizeMode: 'contain' }} source={{ uri: 'ic_btn_signup' }} />
                            </TouchableOpacity>
